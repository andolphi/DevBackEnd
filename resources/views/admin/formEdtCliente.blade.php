              ...
              <div class="card-body">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                            <form method="post" action="{{ route('admin.edtCliente',$cliente->id) }}" onsubmit="this.alterar.style.pointerEvents = 'none'; this.alterar.textContent = 'Alterando...'">
                                @csrf
                                  ...
                                  <div class="col-md-6">
                                     <select class="form-control @error('vendedor_id') is-invalid @enderror" name="vendedor_id" aria-describedby="vendedorHelp" >
                                      ...
                                      @foreach ($vendedores as $vend)
                                          <option {{($vend->id === $cliente->vendedor_id)?'selected':''}} value="{{$vend->id}}">{{$vend->name}}</option>
                                      @endforeach
                                     </select>
                                ...
                                @endif
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-md-6">
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" required autocomplete="new-password" maxlength="100" value="{{$cliente->name}}" aria-describedby="nameHelp" >
                            ...
                            <script type="text/javascript">
                              $('select[name=empresa_id]').change(function(){
                                ...
                                $.get("{{route('home')}}/getVencimento/" + {{$cliente->id}} + "/" + empresa_id   , function(dia_venc){
